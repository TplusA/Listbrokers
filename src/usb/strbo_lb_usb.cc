...
DBusAsync::WorkQueue
USBListTreeData::navlists_get_range_(DBusAsync::WorkQueue::Mode::ASYNC);
DBusAsync::WorkQueue
USBListTreeData::navlists_get_list_id_(DBusAsync::WorkQueue::Mode::ASYNC);
DBusAsync::WorkQueue
USBListTreeData::navlists_get_uris_(DBusAsync::WorkQueue::Mode::ASYNC);
DBusAsync::WorkQueue
USBListTreeData::navlists_realize_location_(DBusAsync::WorkQueue::Mode::ASYNC);
...
static int create_list_tree_and_cache(USBListTreeData &lt, GMainLoop *loop)
{
    ...
    lt.list_tree_ =
        std::make_unique<USB::ListTree>(
            USBListTreeData::navlists_get_range_,
